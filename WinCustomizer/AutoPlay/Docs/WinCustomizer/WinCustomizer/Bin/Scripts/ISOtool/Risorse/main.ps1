<<<<<<< HEAD:WinCustomizer/AutoPlay/Docs/WinCustomizer/WinCustomizer/Bin/Scripts/ISOtool/Risorse/main.ps1
...
>>>>>>> parent of 2f20d51 (fix login):WinCustomizer/Risorse/main.ps1
    shutdown /r /t 20