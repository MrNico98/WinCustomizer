...
$inputXML = @"
<Window x:Class="wincustomizergui.MainWindow"
        xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
        xmlns:d="http://schemas.microsoft.com/expression/blend/2008"
        xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006"
        xmlns:local="clr-namespace:wincustomizergui"
        mc:Ignorable="d"
        Title="WinCustomizerGUI" Height="450" Width="430" AllowDrop="True">
    <Grid Background="#FF96FF83">
        ...
        <Button Content="Attiva WSA" Name="sottosistema" Height="35" Margin="145,149,125,0" VerticalAlignment="Top" Background="White" BorderBrush="White" Foreground="#FFFF0909" Focusable="False" ScrollViewer.CanContentScroll="False" AllowDrop="True"/>
        <Image x:Name="AttivaWSA" SnapsToDevicePixels="True" Source="https://raw.githubusercontent.com/MrNico98/Icone-Wincustomizer/main/WSA.png" Margin="148,152,0,0" RenderTransformOrigin="-0.288,1.552" Height="30" Width="40" ScrollViewer.CanContentScroll="False" AllowDrop="True" VerticalAlignment="Top" HorizontalAlignment="Left"/>
        <Button Content="Edizione Windows" Name="cambiowindows" Margin="145,205,125,0" Background="White" BorderBrush="White" Foreground="#FFFF0909" Focusable="False" ScrollViewer.CanContentScroll="False" AllowDrop="True" Height="35" VerticalAlignment="Top"/>
        <Image x:Name="EdizioneWindows" SnapsToDevicePixels="True" Source="https://raw.githubusercontent.com/MrNico98/Icone-Wincustomizer/main/cambioedizione.png" Margin="133,205,0,0" RenderTransformOrigin="-0.288,1.552" ScrollViewer.CanContentScroll="False" AllowDrop="True" HorizontalAlignment="Left" Width="33" Height="35" VerticalAlignment="Top"/>
        <Button Content="Attiva Windows" Name="attivawin" Margin="145,259,125,0" Background="White" BorderBrush="White" Foreground="#FFFF0909" Focusable="False" ScrollViewer.CanContentScroll="False" AllowDrop="True" Height="35" VerticalAlignment="Top"/>
        <Image x:Name="AttivaWindows" SnapsToDevicePixels="True" Source="https://raw.githubusercontent.com/MrNico98/Icone-Wincustomizer/main/maxresdefault.png" Margin="146,263,0,0" RenderTransformOrigin="-0.288,1.552" Width="30" ScrollViewer.CanContentScroll="False" AllowDrop="True" HorizontalAlignment="Left" Height="30" VerticalAlignment="Top"/>
        <Button Content="Office" Name="off" Margin="145,311,125,0" Background="White" BorderBrush="White" Foreground="#FFFF0909" Focusable="False" ScrollViewer.CanContentScroll="False" AllowDrop="True" Height="35" VerticalAlignment="Top"/>
        <Image x:Name="Office" Source="https://raw.githubusercontent.com/MrNico98/Icone-Wincustomizer/main/office.png" Margin="145,314,0,0" RenderTransformOrigin="0.5,0.5" Width="29" Height="30" ScrollViewer.CanContentScroll="True" AllowDrop="True" VerticalAlignment="Top" HorizontalAlignment="Left"/>
        <Label Content="Ver.: 3.0" HorizontalAlignment="Left" Height="30" Margin="368,376,0,0" VerticalAlignment="Top" Width="62"/>
        <Label Content="Developer: MrNico98" HorizontalAlignment="Left" Height="30" Margin="0,376,0,0" VerticalAlignment="Top" Width="133"/>
        <Button Content="App Debloat" x:Name="deb" Margin="145,357,125,0" Background="White" BorderBrush="White" Foreground="#FFFF0909" Focusable="False" ScrollViewer.CanContentScroll="False" AllowDrop="True" Height="35" VerticalAlignment="Top"/>
        <Image x:Name="debloimage" Source="https://raw.githubusercontent.com/MrNico98/Icone-Wincustomizer/main/Picsart_23-09-22_22-29-23-192.png" Margin="147,344,0,0" RenderTransformOrigin="0.5,0.5" Width="43" Height="46" ScrollViewer.CanContentScroll="True" AllowDrop="True" VerticalAlignment="Top" HorizontalAlignment="Left"/>
        <TextBlock HorizontalAlignment="Left" Height="30" Margin="106,6,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="238" FontFamily="Kristen ITC" FontWeight="Bold" FontSize="22"><Run Language="it-it" Text="WinCustomizerGUI"/></TextBlock>
        </Grid>
...
$WPFtooliso.Add_Click({
    ...
    $secondForm.Size = New-Object System.Drawing.Size(400, 250)
    ...
    cd "$env:USERPROFILE\Desktop\WinCustomizerGUI"
    Start-Process -FilePath ".\isotool11.exe" -Wait
    if (-not (Test-Path -Path "$env:USERPROFILE\Desktop\WinCustomizerGUI\isotool11.exe" -PathType Leaf)) {
    ...
    cd "$env:USERPROFILE\Desktop\WinCustomizerGUI"
    Start-Process -FilePath ".\isotool10.exe" -Wait
    if (-not (Test-Path -Path "$env:USERPROFILE\Desktop\WinCustomizerGUI\isotool10exe" -PathType Leaf)) {
    Error('Il programma non presente')} else {True('FATTO')}
    })
...
$WPFdeb.Add_Click({
    Log('Eseguo APP Debloat')
    copy "Risorse\MrNico98Debloat3.0.exe" "$env:USERPROFILE\Desktop"
    warning('App copiata sul desktop') 
    if (-not (Test-Path -Path "$env:USERPROFILE\Desktop\WinCustomizerGUI\Risorse\MrNico98Debloat3.0.exe" -PathType Leaf)) {
...
$WPFtips.Add_Click({
    ...
    $debloatForm.Controls.AddRange($debloatcalssico)
     ...
     True('FATTO')
      ...
      If (10 -eq $os) {
      log ('Inzio Debloat')
     Get-AppxPackage -AllUsers | Where-Object {$_.name -notmatch 'Microsoft.VP9VideoExtensions|Microsoft.WebMediaExtensions|Microsoft.WebpImageExtension|Microsoft.Windows.ShellExperienceHost|Microsoft.VCLibs*|Microsoft.DesktopAppInstaller|Microsoft.StorePurchaseApp|Microsoft.Windows.Photos|Microsoft.WindowsStore|Microsoft.XboxIdentityProvider|Microsoft.WindowsCalculator|Microsoft.HEIFImageExtension|Microsoft.UI.Xaml*'} | Remove-AppxPackage
     Get-Process OneDrive | Stop-Process -Force
     C:\Windows\System32\OneDriveSetup.exe /uninstall
     Set-ItemProperty -Path "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" -Name "OemPreInstalledAppsEnabled" -Type DWord -Value 0
     Set-ItemProperty -Path "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" -Name "PreInstalledAppsEnabled" -Type DWord -Value 0
   ...
   Set-ItemProperty -Path "HKCU\Control Panel\Colors" -Name "ImmersiveApplicationForeground" /t REG_SZ /d "255 255 255" /f
   ...
   Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "ImmersiveApplicationForeground" -Value "255 255 255"
   ...
   Set-ItemProperty -Path "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Chat" -Name "ChatIcon" -Type DWord 3 /f
   Set-ItemProperty -Path "HKCU\Control Panel\UnsupportedHardwareNotificationCache" -Name SV1 -Type DWord -Value 0
   Set-ItemProperty -Path "HKCU\Control Panel\UnsupportedHardwareNotificationCache" -Name SV2 -Type DWord -Value 0
   ...
   Set-ItemProperty -Path "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "TaskbarDa" -Type DWord -Value 0
   True('FATTO')
 }
 })
   ...
   if (-not (Test-Path -Path "$env:USERPROFILE\Desktop\WinCustomizerGUI\Risorse\edgerimozione.exe" -PathType Leaf)) {
    Error('Programma non presente')} else {True('Avvio rimozione Microsoft Edge')
    Start-Process -FilePath "$env:USERPROFILE\Desktop\WinCustomizerGUI\Risorse\edgerimozione.exe" -Wait
    }    
   })
  ...
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MsSecCore /v Start /t REG_DWORD /d 4 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\wscsvc /v Start /t REG_DWORD /d 4 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WdNisDrv /v Start /t REG_DWORD /d 4 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WdNisSvc /v Start /t REG_DWORD /d 4 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WdFiltrer /v Start /t REG_DWORD /d 4 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WdBoot /v Start /t REG_DWORD /d 4 /f"
  ...
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SgrmAgent /v Start /t REG_DWORD /d 4 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SgrmBroker /v Start /t REG_DWORD /d 4 /f"
  ...
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DefenderApiLogger /v Start /t REG_DWORD /d 0 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DefenderApiLogger /v Status /t REG_DWORD /d 0 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DefenderAuditLogger /v Start /t REG_DWORD /d 0 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DefenderAuditLogger /v Status /t REG_DWORD /d 0 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DefenderAuditLogger /v EnableSecurityProvider /t REG_DWORD /d 0 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg delete HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v SecurityHealth /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\Features /v MpPlatformKillbitsFromEngine /t REG_BINARY /d 0000000000000000 /f"L
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\Features /v TamperProtectionSource /t REG_DWORD /d 0 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\Features /v MpCapability /t REG_BINARY /d 000000000000000000 /f"
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\Features /v TamperProtection /t REG_DWORD /d 0 /f"
  Risorse\PowerRun.exe cmd.exe /c "for /r "C:\ProgramData\Microsoft\Windows Defender\Platform" %I in (MsMpEng.exe) do @if exist "%I" ren "%I" MsMpEng.exe.bak" 
  ...
  Risorse\PowerRun.exe cmd.exe /c "cd C:\Windows\System32 && ren smartscreen.exe smartscreen.exe.bak"
  ...
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MsSecCore /v Start /t REG_DWORD /d 3 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\wscsvc /v Start /t REG_DWORD /d 2 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WdNisDrv /v Start /t REG_DWORD /d 3 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WdNisSvc /v Start /t REG_DWORD /d 3 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WdFiltrer /v Start /t REG_DWORD /d 0 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WdBoot /v Start /t REG_DWORD /d 2 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SecurityHealthService /v Start /t REG_DWORD /d 2 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SgrmAgent /v Start /t REG_DWORD /d 2 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SgrmBroker /v Start /t REG_DWORD /d 2 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WinDefend /v Start /t REG_DWORD /d 2 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DefenderApiLogger /v Start /t REG_DWORD /d 1 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DefenderApiLogger /v Status /t REG_DWORD /d 0 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DefenderAuditLogger /v Start /t REG_DWORD /d 1 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DefenderAuditLogger /v Status /t REG_DWORD /d 0 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DefenderAuditLogger /v EnableSecurityProvider /t REG_DWORD /d 1 /f">NUL
  New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Run" -Name "SecurityHealth" -Value "$env:windir\system32\SecurityHealthSystray.exe" -PropertyType String -Force
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\Features /v TamperProtection /t REG_DWORD /d 1 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\Features /v MpPlatformKillbitsFromEngine /t REG_BINARY /d 0000000000000001 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\Features /v TamperProtectionSource /t REG_DWORD /d 5 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\Features /v MpCapability /t REG_BINARY /d ff01000000000000 /f">NUL
  Risorse\PowerRun.exe cmd.exe /c "for /r "C:\ProgramData\Microsoft\Windows Defender\Platform" %I in (MsMpEng.exe.bak) do @if exist "%I" ren "%I" MsMpEng.exe" 
  cmd.exe /c reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender" /v DisableAntiSpyware /t REG_DWORD /d 0 /f >NUL
  Risorse\PowerRun.exe cmd.exe /c "cd C:\Windows\System32 && ren smartscreen.exe.bak smartscreen.exe" >NUL
  start-process explorer
  True('FATTO, riavvio sistema in 20 secondi')
  timeout 20
  shutdown /r /t 00 
  ...
  $defenderForm.ShowDialog()
   ...
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "SyncDisabled" -Type DWord -Value 1
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "BrowserSignin" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "NewSmartScreenLibraryEnabled" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "SmartScreenEnabled" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "SmartScreenPuaEnabled" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "StartupBoostEnabled" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "BingAdsSuppression" -Type DWord -Value 1
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "BackgroundModeEnabled" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "ComponentUpdatesEnabled" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "EdgeShoppingAssistantEnabled" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "ForceGoogleSafeSearch" -Type DWord -Value 1
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge" -Name "MAUEnabled" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate" -Name "AutoUpdateCheckPeriodMinutes" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate" -Name "UpdateDefault" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate" -Name "UpdatePolicy" -Type DWord -Value 0
   Set-ItemProperty -Path "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft" -Name "DoNotUpdateToEdgeWithChromium" -Type DWord -Value 1
   True('FATTO')
})
  ...
  $debloatForm.ShowDialog()
   ...
   Log('Ripristino Windows con DIS')
    ...
    mkdir "$env:USERPROFILE\Desktop\DriverPC"
    dism.exe /online /export-driver /destination:$env:USERPROFILE\Desktop\DriverPC
    $desktopPath = [System.Environment]::GetFolderPath('Desktop')
    $outputFilePath = Join-Path -Path $desktopPath -ChildPath 'DriverPC\driver.txt'
...
$adapterChoice = Read-Host "Enter Network Adapter Name (1 for Ethernet and 2 for Wi-Fi or write something else...):"
...
$WPFsottosistema.Add_Click({
  ...
  $androidform.Text = "Attiva Sottosistema Andorid"
    ...
    $wsadownload.Add_Click({
     ...
     $medio="$env:USERPROFILE\Desktop\WinCustomizerGUI\Risorse"
     $medino="$env:USERPROFILE\Desktop\WinCustomizerGUI\Risorse\WSA"
     $fine="$env:USERPROFILE\Desktop"

     Start-Process "https://mega.nz/file/SzYCyQpQ#ZmBvGF3k-Qg8MOUt0p6idQf1bHBJjQHUstz3agBLNvs"
     ...
     Expand-Archive "Risorse\WSAwin11x64.zip" "Risorse\WSA"
     Move-Item -path $medino -Destination $fine -Force
     powershell.exe -ExecutionPolicy Bypass -File "$env:USERPROFILE\Desktop\run.bat"
     }
     }
     ...
     Read-host "Salva nella cartella Downloads e digita 'FINE' al termine del download"
     Move-Item -path $origine -Destination $medio -Force
     Expand-Archive "Risorse\WSAwin10x64.zip" "Risorse\WSA"
     Move-Item -path $medino -Destination $fine -Force
     powershell.exe -ExecutionPolicy Bypass -File "env:USERPROFILE\Desktop\Install.ps1"
     }
     ...
     Read-host "Salva nella cartella Downloads e digita 'FINE' al termine del download"
     Move-Item -path $origine -Destination $medio -Force
     Expand-Archive "Risorse\WSAwin11arm64.zip" "Risorse\WSA"
     Move-Item -path $medino -Destination $fine -Force
     powershell.exe -ExecutionPolicy Bypass -File "env:USERPROFILE\Desktop\Install.ps1"
     True('FATTO')
     }
    ...
    $pacmanmedio="env:USERPROFILE\Desktop\WinCustomizerGUI\Risorse\WSAPacMan"
...
Log('Avvio cambio edizione windows')
    cd "$env:USERPROFILE\Desktop\WinCustomizerGUI\Risorse"
    Start-Process -FilePath ".\MrNico98CambioEdizioneWindows.exe" -Wait
    if (-not (Test-Path -Path "$env:USERPROFILE\Desktop\WinCustomizerGUI\Risorse\MrNico98CambioEdizioneWindows.exe" -PathType Leaf)) {
    Error('Programma non presente')} else {True('FATTO')}
    })
...
Log('Avvio attivazione Windows')
 cd "$env:USERPROFILE\Desktop\WincustomizerGUI"
 Start-Process -FilePath ".\Risorse\MrNico98Attivatore.exe"
 True('FATTO')
 })
...
$WPFoff.Add_Click({
    ...
    mkdir "$env:USERPROFILE\Desktop\WinCustomizerGUI\Office2021\configuration"
    ...
    Remove-Item -Path "$env:USERPROFILE\Desktop\WinCustomizerGUI\Office2021" -Recurse -Force
    True('FATTO')
    })
...
Remove-Item -Path "Office2021-main.zip" -Recurse -Force
mkdir "$env:USERPROFILE\Desktop\WinCustomizerGUI\Office2021\configuration"
Move-Item -Path "$env:USERPROFILE\Desktop\configuration-x64-complete.xml" -Destination "$env:USERPROFILE\Desktop\WinCustomizerGUI\Office2021\configuration" -Force
Start-Process -FilePath ".\Office2021\Install-x64-complete.bat" -Wait
Remove-Item -Path "$env:USERPROFILE\Desktop\WinCustomizerGUI\Office2021" -Recurse -Force
True('FATTO')
    })
...
Remove-Item -Path "Office2021-main.zip" -Recurse -Force
mkdir "$env:USERPROFILE\Desktop\WinCustomizerGUI\Office2021\configuration"
Move-Item -Path "$env:USERPROFILE\Desktop\configuration-x32-complete.xml" -Destination "$env:USERPROFILE\Desktop\WinCustomizerGUI\Office2021\configuration" -Force
...
True('FATTO')
  ...
  log('Attivo Office')
  cd "$env:USERPROFILE\Desktop\WinCustomizerGUI\Risorse"
  start-process -FilePath "MrNico98OfficeAttivatore.exe"
  if (-not (Test-Path -Path "$env:USERPROFILE\Desktop\WinCustomizerGUI\Risorse\MrNico98OfficeAttivatore.exe" -PathType Leaf)) {
  Error('Programma non presente')} else {True('FATTO')}
  })
  ...
  warning('Apriro una pagina internet, il file potrebbe essere riconosciuto come falso positivo, disabilitare antivirus')
  warning('Per scaricarlo fare click su CODE e poi Download ZIP')
  Start-Process "https://github.com/MrNico98/ScrubberOffice/tree/main"
  True('FATTO')
  })
