...
title WinCustomizer Disinstallazione Office
echo.
echo ============================================================
echo Verifico installazione office, attendi . . .
...
set _er=0
call :Hdr
echo [1] Dinstalla completamente office
...
echo.
echo ============================================================
choice /c 12345678CRTU0 /n /m "Seleziona un numero e premi invio, o premi 0 per uscire: "
set _er=%ERRORLEVEL%
...
echo.
echo ============================================================
choice /c 123456780 /n /m "Seleziona un numero e premi invio, o premi 0 per uscire: "
set _er=%ERRORLEVEL%
...
set "msg=Finito. Riavvia il sistema per completare l'operazione."
goto :TheEnd
...
:E_Admin
set "msg=ERRORE: Lo script richiede i privilegi di amministrazione."
goto :TheEnd
