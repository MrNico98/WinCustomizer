...
title MrNico98 Disinstalla Office
echo.
echo ============================================================
echo Rilevo le versioni di office, attendi . . .
...
set _er=0
call :Hdr
echo [1] Disinstalla Tutto
echo [2] Disinstalla Office C2R  %dOCTR%
echo [3] Disinstalla Office 2016 %dOM16%
echo [4] Disinstalla Office 2013 %dOM15%
echo [5] Disinstalla Office 2010 %dOM14%
echo [6] Disinstalla Office 2007 %dOM12%
echo [7] Disinstalla Office 2003 %dOM11%
if %winbuild% GEQ 10240 echo [8] Disinstalla Office UWP  %dOUWP%
echo.
echo. --- Office 2016 e superiori ---
echo [C] Puliza Licenze vNext %dONXT%
echo [R] Rimuovi tutte le license
echo [T] Resetta licenza C2R
echo [U] Disinstalla tutte le chiavi
echo.
echo ============================================================
choice /c 12345678CRTU0 /n /m "Premi un numero, o premi 0 per uscire: "
set _er=%ERRORLEVEL%
...
echo ============================================================
choice /c 123456780 /n /m "Seleziona numero, o premi 0 per uscire: "
set _er=%ERRORLEVEL%
...
if exist "!_file!" (
echo.
echo Eseguo OfficeClickToRun.exe . . .
...
:rOM16
echo.
echo DisinstalloOffice 2016 MSI . . .
call :cKpp 16
...
:rOM15
echo.
echo DisinstalloOffice 2013 MSI . . .
call :cKpp 15
...
echo.
echo Riaggiorno le licenze di Windows Insider Preview. . .
...
set "msg=Fatto. Riavvia il sistema per completare l'operazione"
goto :TheEnd
...
call :Hdr
echo.
echo Rimuovo le licenze di office . . .
call :oppcln
call :slmgr
set "msg=Done."
goto :TheEnd
...
call :Hdr
echo.
echo RResetto le licenze Office C2R . . .
if %_O16CTR% equ 0 (
...
echo.
echo Rimuovo licenze Office . . .
call :oppcln
call :slmgr
echo.
echo Installo licenza Office C2R. . .
for %%a in (%_SKUs%) do (
